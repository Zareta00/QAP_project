...
class ChangePassLocators:
    ...
    CHANGE_PASS_ERROR_INVALID_USERNAME_OR_TEXT = (By.XPATH,
                                                  "//span[@id='form-error-message' and contains(text(),"
                                                  "'Неверный логин или текст с картинки')]")


class RegLocators:
    REG_HEADING = (By.XPATH, "//h1[contains(text(),'Регистрация')]")
    REG_FIRST_NAME_INPUT_PAGE_RIGHT = (By.XPATH,
                                       "//section[@id='page-right']//span[contains(text(),"
                                       "'Имя')]/preceding-sibling::input")
    REG_REGISTER_BUTTON_PAGE_RIGHT = (By.XPATH,
                                      "//section[@id='page-right']//span[contains(text(),'Зарегистрироваться')]")
    ...
    REG_ERROR_FIRST_NAME_INPUT = (By.XPATH, "//span[contains(text(),"
                                            "'Необходимо заполнить поле кириллицей. От 2 до 30 с')]")
    REG_EMAIL_PHONE_INPUT = (By.XPATH, "//input[@id='address']")
    REG_EMAIL_PHONE_INPUT_VALUE = (By.XPATH, "//input[@type='hidden' and @name='address']")
    REG_ERROR_INVALID_EMAIL_OR_PHONE_INPUT = (By.XPATH, "//span[contains(text(),"
                                                        "'Введите телефон в формате +7ХХХХХХХХХХ или +375XXX')]")
    REG_PASSWORD_INPUT = (By.XPATH, "//input[@id='password']")
    REG_ERROR_INVALID_PASSWORD_INPUT = (By.XPATH, "//span[contains(text(),"
                                                  "'Пароль должен') or contains(text(),'Длина пароля')]")
    ...
    REG_ENTER_BUTTON = (By.XPATH, "//button[@class='rt-btn rt-btn--orange "
...
class UserAgreementLocators:
    USER_AGREEMENT_HEADING = (By.XPATH, "//h1[contains(text(),'Пользователь')]")


class RejectedRequestLocators:
    REJECTED_REQUEST_HEADING = (By.XPATH, "//h2[contains(text(),"
                                          "'Ваш запрос был отклонен из соображений безопасности.')]")
