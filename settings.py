...
url_change_pass = "https://b2c.passport.rt.ru/auth/realms/b2c/login-actions/reset-credentials"
...
def random_int():
    random_int = random.randint(1, 66666666666)
    return random_int
...
def valid_phone():
    random_valid_phone = random.randint(2222222222, 8888888888)
...
def first_name_last_name():
    random_first_last_name = Faker().name()
    return random_first_last_name
...
valid_email_or_phone = [valid_email(), "75785398583", "375749360386"]
